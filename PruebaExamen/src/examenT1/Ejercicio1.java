...
public class Ejercicio1 {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("(3) Calcular el menor");
			...
			if(opcion == 0) {
				...
				switch(opcion) {
				case 1:
					int producto = multiplicar(n1,n2,n3,n4);
				...
				case 2:
					...
					break;
				case 3:
					int menor12 = menorEntreDos(n1,n2);
					int menor123 = menorEntreDos(menor12,n3);
					int menorFinal = menorEntreDos(menor123, n4);
					System.out.println("El menor de estos número es : " +menorFinal);
					break;
				}
			}else {
	...
	public static int menorCuatro(int a, int b, int c, int d) {
		int menor = a;
	...
	public static int menorEntreDos(int a, int b) {
        if (a < b) {
            return a;
        } else {
            return b;
