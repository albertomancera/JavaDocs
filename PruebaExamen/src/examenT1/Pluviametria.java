...
public class Pluviametria {
	...
	public static void main(String[] args) {
		...
		System.out.println("A)");
		    ...
		    System.out.println("============");
		    mostrarMunicipiosPorEncimaMedia();
	...
	//Array con los nombres de los 10 municipios
		...
		public static double calcularMediaPluviometricaTotal() {
			...
			for (int i = 0; i < municipios.length; i++) { //rECORREMOS TODOS LOS MUNICIPIOS 
				for(int j = 0; j < datos[i].length; j++) {  //Y TODOS SUS DIAS
					sumaTotal += datos[i][j];  //SUMANDO CADA DATO DE LLUVIA
				}
			}
