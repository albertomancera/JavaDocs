...
public class Armario extends Almacenaje{
	...
	public Armario(int numPuertas){
		this(PRECIO_DEFECTO, DESCRIPCION_DEFECTO, ANCHURA_DEFECTO, ALTURA_DEFECTO,MAX_MODULOS,numPuertas);
	}
	...
	public String toString() {
		return super.toString() + " Numero de puertas: "+ getNumPuertas();
	}
}
