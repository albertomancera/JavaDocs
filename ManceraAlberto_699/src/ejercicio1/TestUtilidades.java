...
public class TestUtilidades {
    ...
    /**
     * M�todo de consulta de atributos est�ticos de la clase
     *
     * @return String Consulta de atributos est�ticos de la clase
     */
    ...
    /**
     * M�todo de consulta de atributos p�blicos de la clase
     *
     * @return String Consulta de atributos p�blicos de la clase
     */
    public static String consultaAtributosPublicos() {
        // Se utiliza un objeto de tipo StringBuilder para formatear las pruebas
        StringBuilder consulta = new StringBuilder();
        consulta.append("------------------------------------------------\n");
        consulta.append(" - PRUEBA 01 - ATRIBUTOS P�BLICOS\n");
        consulta.append("------------------------------------------------\n");
    ...
    /**
     * Crea una ComputadorVuelo para una aeronave usando el constructor de tres par�metros
     * 
    ...
    /**
     * Crea una ComputadorVuelo para una aeronave usando el constructor de dos par�metros
     * 
     * @param matricula Matr�cula de la aeronave
     * @param modelo Modelo de la aeonave
     * @return String Consulta de atributos p�blicos de la clase
    ...
    /**
     * Crea una ComputadorVuelo para una aeronave usando el constructor sin par�metros
     * 
     * @return String Consulta de atributos p�blicos de la clase
     */
    public static ComputadorVuelo crearAeronave() {
        ...
        ComputadorVuelo aeronave = null;
        try {
            System.out.printf("Registrando un ComputadorVuelo para una aeronave con los par�metros por defecto\n");
    ...
    /**
     * Crea un array de aeronaves con los datos por defecto usando el m�todo f�brica
     * 
    ...
    public static ComputadorVuelo[] crearArrayAeronaves(int cantidad) {
        ...
        try {
            ...
            System.out.println(" -> Array de Objetos creado con �xito.");
        } catch (IllegalArgumentException e) {
    ...
    public static ComputadorVuelo[] crearArrayAeronavesDatosPrueba() {
        // Se crea un array de dispositivos vac�o
        ComputadorVuelo[] arrayAeronaves = new ComputadorVuelo[5];

        // Se crean 5 dispositivos de ejmplo con datos usando el constructor de 3 par�metros
        arrayAeronaves[0] = TestUtilidades.crearAeronave("EC-FEC", "Cessna 172", "Ra�l L�pez");
        arrayAeronaves[1] = TestUtilidades.crearAeronave("EC-FA3", "Eurostar Evektor EV-97", "Eva Lozano");
        arrayAeronaves[2] = TestUtilidades.crearAeronave("EC-IOF", "Tecnam P92", "Santiago V�zquez");
        arrayAeronaves[3] = TestUtilidades.crearAeronave("EC-FE1", "Dassault Falcon 900", "Pedro S�nchez");
    ...
    /**
     * Realiza una prueba del m�todo de despegue del ComputadorVuelo realizando controlando las excepciones
     *
    ...
    {
        // Testea el m�todo de despegue y captura las excepciones
        try {
    ...
    /**
     * Realiza una prueba del m�todo aterrizar del ComputadorVuelo realizando controlando las excepciones
     *
     * @param aeronave Aeronave (ComputadorVuelo)
     */
    public static void pruebaMetodoAterrizar(ComputadorVuelo aeronave)
    {
        // Genera una excepci�n: una aeronave que no est� volando no puede aterrizar
        try {
